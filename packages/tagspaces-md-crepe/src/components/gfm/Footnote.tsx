...
export const FootnoteDef: FC = () => {
  ...
  return (
    <dl
      className="relative flex gap-2 rounded border-2 border-gray-300 bg-gray-50 p-3 dark:border-gray-500 dark:bg-gray-900"
    ...
    >
      ...
      >
        <a className="p-2 text-nord8" href={`#footnote-${label}-ref`}>
          ↩
        </a>
      </div>
    </dl>
