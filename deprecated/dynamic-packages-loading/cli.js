...
const parser = yargs(hideBin(process.argv))
  .usage(
    "Usage: $0 ../ -p [string] [extra npm arguments: --platform=linux --arch=x64 --prefix=../../]"
  )
  .option("dedupe", {
    alias: "d",
    type: "boolean",
  ...
  .option("prefix", {
    ...
    type: "string",
    default: "",
    description: "add --prefix as npm argument (change install directory)",
  })
  .help("h")
  .alias("h", "help")
  .fail(false);
